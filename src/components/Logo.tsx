    ...
    return (
        ...
        >
            ...
            <g transform="matrix(4.16667,0,0,4.16667,0,2396.62)">
                <rect x="57.758" y="25.857" width="127.667" height="215.018" fill="#E30613" />
            </g>
            <g transform="matrix(4.16667,0,0,4.16667,0,2396.62)">
                <rect x="232.46" y="25.857" width="127.667" height="215.018" fill="#E30613" />
            </g>
            <g transform="matrix(4.16667,0,0,4.16667,0,2396.62)">
                <rect x="409.851" y="25.857" width="127.667" height="215.018" fill="#E30613" />
            </g>
            <g transform="matrix(4.16667,0,0,4.16667,0,1014.55)">
                <rect x="57.758" y="236.603" width="479.76" height="125.221" fill="#E30613" />
            </g>
            <g transform="matrix(4.16667,0,0,4.16667,0,132.608)">
                <rect x="57.758" y="347.48" width="215.018" height="115.134" fill="#E30613" />
            </g>
            <g transform="matrix(4.16667,0,0,4.16667,0,132.608)">
                <rect x="322.499" y="347.48" width="215.018" height="115.134" fill="#E30613" />
            </g>
            <g transform="matrix(0,-1,1,0,182.895,1149.39)">
                <g transform="matrix(0.933888,0,0,1,-23.9962,0)">
                    <text x="-362.964px" y="178.454px" style={{ fontFamily: "'Helvetica'", fontSize: '168.27px', fill: '#000000' }}>
            ...
            <g transform="matrix(1,0,0,1,386.307,474.811)">
                <g transform="matrix(1.04184,0,0,1,-5.10464,0)">
                    <text x="121.992px" y="597.789px" style={{ fontFamily: "'Helvetica'", fontSize: '624.366px', fill: '#000000' }}>
                ...
                <g transform="matrix(1.04184,0,0,1,-6.86173,0)">
                    <text x="163.983px" y="1026.28px" style={{ fontFamily: "'Helvetica'", fontSize: '597.068px', fill: '#000000' }}>
            ...
            <g transform="matrix(0,-1,1,0,316.029,1154.67)">
                <g transform="matrix(0.933888,0,0,1,-24.1067,0)">
                    <text x="-364.634px" y="220.96px" style={{ fontFamily: "'Helvetica'", fontSize: '168.917px', fill: '#000000' }}>
